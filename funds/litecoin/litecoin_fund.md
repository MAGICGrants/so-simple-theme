...
[Litecoin](https://litecoin.org) is a well-known public protocol and network that is widely distributed and supported on exchanges worldwide (the **Project**). Because it is so decentralized, Litecoin would benefit significantly from a side nonprofit such as MAGIC Grants. The MAGIC Litecoin Fund will issue grants for various qualifying needs in the Litecoin ecosystem.

Some members of the Litecoin community operate the [Litecoin Foundation](https://litecoin.net), a Singapore Foundation, whose purpose is to support the Litecoin ecosystem. Some Litecoin community members wished for a more common charity type based in the United States that allowed for deductible donations, while still allowing this committee to engage with the Litecoin community on a regular basis. The MAGIC Litecoin Fund addresses these goals by relying on the foundational structure of MAGIC Grants and by being a part of a separate organization whose role is supportive, not directive.
...
* Full tax deductibility of donations as allowable by law, regardless of asset (eg: USD, LTC, BTC, XMR, NFTs, stock).
...
* The [formation of the MAGIC Monero Fund](https://magicgrants.org/Monero-Fund/) and their [first research grant](https://monero.observer/magic-monero-fund-committee-funds-first-research-proposal/)
...
MAGIC Litecoin Fund (emails all committee members): [LitecoinFund@magicgrants.org](mailto:LitecoinFund@magicgrants.org)
