...
[Counterparty](https://counterparty.io) is a public protocol and network that extends the functionality of Bitcoin to include custom assets and other features (the **Project**). Because it is so decentralized, Counterparty would benefit significantly from a side nonprofit such as MAGIC Grants. The MAGIC Counterparty Fund will issue grants for various qualifying needs in the Counterparty ecosystem.

For some time, members of the community have attempted to establish the XCP Foundation. Community concerns arose from the administrative costs of having a separate foundation and from the optics of potentially appearing to represent the entire Counterparty decentralized community. The MAGIC Counterparty Fund addresses these concerns by relying on the foundational structure of MAGIC Grants and by being a part of a separate organization whose role is supportive, not directive.
...
MAGIC Counterparty Fund (emails all committee members): [CounterpartyFund@magicgrants.org](mailto:CounterpartyFund@magicgrants.org)
